...
{
    enum TMessage { FULLNAME_CHANGED, DATEOFBIRTH_CHANGED, STATUS_CHANGED, SCHOOL_CHANGED, HIGHSCHOOL_CHANGED, FRIEND_ADDED,
        NEWS_ADDED, PICTURE_ADDED, FRIEND_DELETED, NEWS_DELETED, PICTURE_DELETED }
    class TJournalEntry
    {
